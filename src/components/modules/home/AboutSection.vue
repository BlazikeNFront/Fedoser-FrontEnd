...
import AnimatedAppName from "./AnimatedAppName.vue";
...
async function redirectAndScrollToSignUpForm() {
  await router.push({ name: RoutesNames.SIGN_IN });
  showErrorModal(t("alphaInfo.signUpDisabled"), false);
