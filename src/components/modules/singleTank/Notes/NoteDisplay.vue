<template>
  <v-container>
    <v-row>
      ...
      <v-col cols="12" lg="6" v-if="note.description">
        <description-display
      ...
      <v-col cols="12" v-if="note.enviromentalData">
        <enviromental-data-display
          ...
          :enviromental-data="note.enviromentalData"
        />
      </v-col>
      <slot />
    </v-row>
...
import NoteTitleDisplay from "@/components/common/Tank/TankBasicInfoDisplays/NoteTitleDisplay.vue";
